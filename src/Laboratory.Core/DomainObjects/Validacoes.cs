...
namespace Laboratory.Core.DomainObjects
{
    public class Validations
    {
        ...
        public static void ValidateIfMinorEqualMinimum(decimal value, int minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void ValidateIfMinorEqualMinimum(float value, int minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void ValidateIfMinorEqualMinimum(double value, int minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void ValidateIfMinorEqualMinimum(long value, int minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
